...
exports.segmentLabels = exports.defaultRules = exports.coalitionRelations = exports.mediaInvitations = exports.marketingAdvisors = exports.pollsters = exports.questions = exports.events = exports.sponsors = exports.media = exports.parties = exports.regionSeeds = exports.legacyRegionMixes = exports.voterSegments = exports.legacyVoterSegments = exports.partyIds = void 0;
...
const voterSpace_generated_1 = require("./voterSpace.generated");
...
exports.partyIds = ['player', 'civicFront', 'greenFuture', 'laborUnion', 'regionalVoice'];
const vec = (econ, culture, authority) => ({ authority, culture, econ });
const latent8 = (econ, culture, authority, establishment, globalism, green, ukraine) => ({
    authority,
    culture,
    econ,
    establishment,
...
exports.voterSegments = voterSpace_generated_1.essVoterSegments;
const mix = (values) => values;
exports.legacyRegionMixes = {
...
const regionMixes = voterSpace_generated_1.essRegionMixes;
const agendas = {
...
exports.regionSeeds = regions_1.regions.map((region) => ({
    id: region.id,
...
const leader = (charisma, credibility, debate, discipline, empathy, knowledge, stamina) => ({
    charisma,
    credibility,
    debate,
    discipline,
...
void legacyMedia;
exports.media = mediaOutlets_1.mediaOutlets;
exports.sponsors = [
...
exports.mediaInvitations = [];
exports.coalitionRelations = exports.parties.flatMap((partyA) => exports.parties
...
function inferSeedCenter8D(party) {
    ...
    return latent8(field.econ, field.culture, field.authority, clampSeed((reputation.trust + reputation.competence + reputation.integrity) / 1.55 - 0.95 - reputation.controversy * 0.35), clampSeed(-field.culture * 0.45 - field.authority * 0.25 - security * 0.18 + industry * 0.08), clampSeed(-climate * 0.72 - industry * 0.08), clampSeed(-field.authority * 0.3 - field.culture * 0.16 + security * 0.28 + reputation.consistency * 0.12 - 0.06));
}
function inferSeedWidth8D(party) {
    return latent8(party.field.width.econ, party.field.width.culture, party.field.width.authority, 0.74, 0.72, 0.68, 0.66);
}
function defaultSalience8D() {
    return latent8(1, 1, 1, 0.85, 0.9, 0.85, 0.9);
}
function clampSeed(value) {
    return Math.max(-1, Math.min(1, value));
}
const initialRuntime = (party) => {
...
function createInitialGameState() {
    const partyRuntime = Object.fromEntries(exports.parties.map((party) => [party.id, initialRuntime(party)]));
    const initialState = {
        campaignActionsV2: campaignActionsV2_1.campaignActionsV2,
        coalitionRelations: exports.coalitionRelations,
        events: exports.events,
        grid: [],
        history: [],
        issueLayer: (0, issueSeed_1.createIssueLayerState)(),
        media: exports.media,
        mediaAppearanceResults: [],
        mediaClusterModifiers: [],
        mediaInvitations: exports.mediaInvitations,
        marketingAdvisors: exports.marketingAdvisors,
        mode: 'fullRealism',
        ...
        pollsters: exports.pollsters,
        publicPollsterId: 'medianPlus',
        publicRegionalPolls: {},
        questions: exports.questions,
        regions: exports.regionSeeds,
        regionalSupport: {},
        rngSeed: 42021,
        rules: exports.defaultRules,
        scandals: [],
        segments: exports.voterSegments,
        sponsors: exports.sponsors,
        turnoutModifiers: [],
        version: '0.5-campaign-actions-v2',
        week: 4,
    };
    initialState.mediaInvitations = (0, mediaEngine_1.generateWeeklyMediaInvitations)(initialState, initialState.rngSeed);
    return initialState;
}
exports.segmentLabels = Object.fromEntries(exports.voterSegments.map((segment) => [segment.id, segment.name]));
