...
exports.campaignActionTemplateById = exports.executableCampaignActionTemplates = exports.campaignActionTemplates = void 0;
exports.getActionTemplatesByCategory = getActionTemplatesByCategory;
exports.getActionTemplatesByLegality = getActionTemplatesByLegality;
exports.getCampaignActionTemplate = getCampaignActionTemplate;
...
const campaignActionTemplateDefinitions = [
    {
        ...
        risks: (0, actionTypes_1.actionRisks)({
            "mediaBacklash": 0.03
        }),
        tags: ["field", "region"],
    },
...
exports.campaignActionTemplates = campaignActionTemplateDefinitions.map((action) => ({
    availability: 'player_initiated',
    placement: 'campaign',
    ...action,
}));
exports.executableCampaignActionTemplates = exports.campaignActionTemplates;
exports.campaignActionTemplateById = Object.fromEntries(exports.campaignActionTemplates.map((action) => [action.id, action]));
function getActionTemplatesByCategory(category) {
    return exports.campaignActionTemplates.filter((action) => action.category === category);
}
function getActionTemplatesByLegality(legality) {
    return exports.campaignActionTemplates.filter((action) => action.legality === legality);
}
function getCampaignActionTemplate(id) {
    return exports.campaignActionTemplates.find((action) => action.id === id);
}
