...
exports.peopleOpsTemplates = void 0;
...
exports.peopleOpsTemplates = peopleOps.map(([id, name, effects], index) => ({
    ...
    cost: (0, actionTypes_1.actionCost)({ money: 0.25 + index * 0.06, centralStaffHours: 6 + index, regionalStaffHours: index % 3 === 0 ? 10 : 0, leaderHours: id.includes('leader') ? 4 : 0, fatigue: 0.005 }),
    effects,
    risks: (0, actionTypes_1.actionRisks)({ internalFaction: 0.02, messageDiscipline: 0.01 }),
