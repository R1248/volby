...
const issue = (id, name, domain, description, dimensionLoadings, defaultSalience, controversy, polarization, legibility, shortName = name) => ({
    controversy,
    defaultSalience,
    description,
    dimensionLoadings,
...
exports.programIssues = [
    ...
    issue('greenDeal', 'Green Deal', 'green', 'Postoj k Evropske zelene dohode jako politickemu baliku: klimaticka transformace, evropska regulace, ceny energii, prumysl, doprava a naklady pro domacnosti.', { green: 0.45, globalism: 0.3, establishment: 0.2, ukraine: 0.15, culture: -0.25, econ: -0.05 }, 0.75, 0.9, 0.85, 0.65),
...
const relation = (from, to, type, strength, confidenceForward, confidenceReverse, expectedFromDirection, expectedToDirection, description, salienceSensitive = true) => ({
    confidenceForward,
    confidenceReverse,
    description,
...
function createIssueLayerState() {
    ...
    return {
        ...
        ideologicalFrames: exports.ideologicalFrames,
        issues: exports.programIssues,
        mediaQuestions: exports.mediaQuestions,
        pendingCampaignTripId: exports.tripEvents[0]?.id,
...
function createDefaultIssuePositions() {
    const defaults = {
    ...
    return Object.fromEntries(exports.programIssues.map((item) => [
        item.id,
        {
            issueId: item.id,
