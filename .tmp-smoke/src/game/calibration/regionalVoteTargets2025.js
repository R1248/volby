...
exports.regionalVoteTargets2025 = exports.nationalPartyVoteTargets2025 = exports.nationalVoteTargets2025 = exports.voteAggregationGroups = void 0;
exports.voteAggregationGroups = {
    player: ['player'],
    spolu: ['ods', 'kdu', 'top09'],
    stan: ['stan'],
    pirates: ['pirates'],
...
exports.nationalVoteTargets2025 = withRemainder({
    player: 0.3451,
    spolu: spoluShare,
    stan: 0.1123,
    pirates: 0.0897,
...
exports.nationalPartyVoteTargets2025 = {
    player: exports.nationalVoteTargets2025.player,
    ods: spoluShare * spoluMandateSplit.ods,
    kdu: spoluShare * spoluMandateSplit.kdu,
    top09: spoluShare * spoluMandateSplit.top09,
    stan: exports.nationalVoteTargets2025.stan,
    pirates: exports.nationalVoteTargets2025.pirates,
    spd: exports.nationalVoteTargets2025.spd,
    motorists: exports.nationalVoteTargets2025.motorists,
    stacilo: exports.nationalVoteTargets2025.stacilo,
    prisaha: exports.nationalVoteTargets2025.prisaha,
    generace: exports.nationalVoteTargets2025.generace,
    others: exports.nationalVoteTargets2025.others,
};
exports.regionalVoteTargets2025 = {
...
function pct(values) {
    const shares = Object.fromEntries(Object.entries(values).map(([groupId, value]) => [groupId, value / 100]));
    return withRemainder(shares);
}
function withRemainder(values) {
