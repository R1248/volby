...
function zeroPartyRecord<T>(value: T): Record<PartyId, T> {
  return Object.fromEntries(partyIds.map((partyId) => [partyId, value])) as Record<PartyId, T>;
}
...
export const parties: PartySeed[] = [
  ...
  // Pirates: progressive liberal digital/transparency party, strong in Prague and younger urban electorate, pro-EU and pro-Ukraine.
  {
    ...
    field: partyField({
      amplitude: 0.78,
      center: latent8(-0.18, -0.78, -0.55, 0.08, 0.68, 0.62, 0.65),
      flexibility: 0.58,
      originCenter: latent8(-0.18, -0.78, -0.55, 0.08, 0.68, 0.62, 0.65),
  ...
  // KDU-ČSL: Christian-democratic social-market party, conservative on culture, stronger in Moravia and rural/local networks.
  {
    ...
    field: partyField({
      amplitude: 0.68,
      center: latent8(-0.05, 0.62, 0.22, 0.22, 0.28, 0.08, 0.42),
      flexibility: 0.44,
      originCenter: latent8(-0.05, 0.62, 0.22, 0.22, 0.28, 0.08, 0.42),
